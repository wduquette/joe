...
public class NumberProxy extends TypeProxy<Double> {
    ...
    private Object _acos(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.acos(num)");
        return Math.acos(joe.toDouble(args.get(0)));
    }
    ...
    private Object _asin(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.asin(num)");
        return Math.asin(joe.toDouble(args.get(0)));
    }
    ...
    private Object _atan(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.atan(num)");
        return Math.atan(joe.toDouble(args.get(0)));
    }
    ...
    private Object _atan2(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 2, "Number.atan2(x, y)");
        return Math.atan2(
            joe.toDouble(args.get(0)),
            joe.toDouble(args.get(0))
        );
    }
    ...
    // equal to *num*.
    private Object _ceil(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.ceil(num)");
        return Math.ceil(joe.toDouble(args.get(0)));
    }
    ...
    private Object _clamp(Joe joe, ArgQueue args) {
    ...
    private Object _cos(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.cos(a)");
        return Math.cos(joe.toDouble(args.get(0)));
    }
    ...
    private Object _exp(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.exp(num)");
        return Math.exp(joe.toDouble(args.get(0)));
    }
    ...
    // equal to *num*.
    private Object _floor(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.floor(num)");
        return Math.floor(joe.toDouble(args.get(0)));
    }
    ...
    private Object _hypot(Joe joe, ArgQueue args) {
    ...
    private Object _log(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.log(num)");
        return Math.log(joe.toDouble(args.get(0)));
    }
    ...
    private Object _log10(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.log10(num)");
        return Math.log10(joe.toDouble(args.get(0)));
    }
    ...
    // single [[List]].
    private Object _max(Joe joe, ArgQueue args) {
        Joe.minArity(args, 1, "Number.max(num...)");
        List<?> list = (args.size() == 1 && args.get(0) instanceof List<?>)
            ? joe.toList(args.get(0))
            : args.asList();
        return list.stream()
            .map(joe::toDouble)
            .max(Double::compare);
    ...
    // The numbers may be passed as individual arguments or as a
    // single [[List]].
    private Object _min(Joe joe, ArgQueue args) {
    ...
    private Object _pow(Joe joe, ArgQueue args) {
    ...
    private Object _random(Joe joe, ArgQueue args) {
    ...
    private Object _round(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.round(num)");
        return (double)Math.round(joe.toDouble(args.get(0)));
    }
    ...
    private Object _sin(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.sin(a)");
        return Math.sin(joe.toDouble(args.get(0)));
    }
    ...
    private Object _sqrt(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.sqrt(num)");
        return Math.sqrt(joe.toDouble(args.get(0)));
    }
    ...
    private Object _tan(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.tan(a)");
        return Math.tan(joe.toDouble(args.get(0)));
    }
    ...
    private Object _toDegrees(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.toDegrees(radians)");
        return Math.toDegrees(joe.toDouble(args.get(0)));
    }
    ...
    private Object _toRadians(Joe joe, ArgQueue args) {
        Joe.exactArity(args, 1, "Number.toRadians(degrees)");
        return Math.toRadians(joe.toDouble(args.get(0)));
    }
}
