...
The `@generic` tag is used for generic proxies,
...
type may be any type in the current documentation set.
...
at the *bottom* of the package file, where it is out of the way.
